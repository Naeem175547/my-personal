...
import { NatsEvents, NatsStatus } from '../events/nats.events.js';
import { NatsOptions, PacketId, ReadPacket, WritePacket } from '../interfaces/index.js';
...
export declare class ClientNats extends ClientProxy<NatsEvents, NatsStatus> {
    ...
    protected statusEventEmitter: EventEmitter<{
        ...
        update: [data?: string | number | import("../events/nats.events.js").ServersChangedEvent | undefined];
    }>;
    ...
    unwrap<T>(): T;
    createSubscriptionHandler(packet: ReadPacket & PacketId, callback: (packet: WritePacket) => any): (error: Error | null, natsMsg: NatsMsg) => Promise<any>;
