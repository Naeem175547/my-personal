...
import { BrokersFunction, Consumer, ConsumerGroupJoinEvent, EachMessagePayload, Kafka, Producer, TopicPartitionOffsetAndMetadata } from '../external/kafka.interface.js';
import { KafkaParser } from '../helpers/index.js';
import { ClientKafkaProxy, KafkaOptions, OutgoingEvent, ReadPacket, WritePacket } from '../interfaces/index.js';
...
export declare class ClientKafka extends ClientProxy<never, KafkaStatus> implements ClientKafkaProxy {
    ...
    private initializeClientAndConnections;
    bindTopics(): Promise<void>;
    createClient<T = any>(): Promise<T>;
