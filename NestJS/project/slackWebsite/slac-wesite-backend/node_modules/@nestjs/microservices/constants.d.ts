...
export declare const RMQ_DEFAULT_URL = "amqp://localhost";
...
export declare const RMQ_DEFAULT_QUEUE = "";
export declare const RMQ_DEFAULT_PREFETCH_COUNT = 0;
export declare const RMQ_DEFAULT_IS_GLOBAL_PREFETCH_COUNT = false;
export declare const RMQ_DEFAULT_QUEUE_OPTIONS: {};
export declare const RMQ_DEFAULT_NOACK = true;
export declare const RMQ_DEFAULT_PERSISTENT = false;
export declare const RMQ_DEFAULT_NO_ASSERT = false;
export declare const RMQ_SEPARATOR = ".";
export declare const RMQ_WILDCARD_SINGLE = "*";
export declare const RMQ_WILDCARD_ALL = "#";
...
export declare const RMQ_NO_EVENT_HANDLER: (text: TemplateStringsArray, pattern: string) => string;
export declare const RMQ_NO_MESSAGE_HANDLER: (text: TemplateStringsArray, pattern: string) => string;
...
export declare const BLOCKED_RMQ_MESSAGE: (reason: string) => string;
export declare const UNBLOCKED_RMQ_MESSAGE = "RMQ broker has unblocked the connection.";
export declare const NATS_DEFAULT_GRACE_PERIOD = 10000;
