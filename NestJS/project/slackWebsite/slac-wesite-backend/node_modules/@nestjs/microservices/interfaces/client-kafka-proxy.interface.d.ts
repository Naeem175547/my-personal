...
import { Consumer, Producer, TopicPartitionOffsetAndMetadata } from '../external/kafka.interface.js';
export interface ClientKafkaProxy extends Omit<ClientProxy<never, KafkaStatus>, 'on'> {
    /**
