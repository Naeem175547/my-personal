...
import { MqttEvents, MqttStatus } from '../events/mqtt.events.js';
import { MessageHandler, PacketId, ReadPacket } from '../interfaces/index.js';
import { MqttOptions, TransportId } from '../interfaces/microservice-configuration.interface.js';
...
export declare class ServerMqtt extends Server<MqttEvents, MqttStatus> {
    ...
    close(): void;
    createMqttClient(): Promise<MqttClient>;
