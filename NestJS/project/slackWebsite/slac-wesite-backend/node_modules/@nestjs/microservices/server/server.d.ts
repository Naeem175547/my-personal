...
import { ClientOptions, MessageHandler, MicroserviceOptions, MsPattern, ReadPacket, WritePacket } from '../interfaces/index.js';
import { ConsumerSerializer } from '../interfaces/serializer.interface.js';
import { ITransportServer, type LoggerService } from '@nestjs/common';
/**
 * @publicApi
 */
export declare abstract class Server<EventsMap extends Record<string, Function> = Record<string, Function>, Status extends string = string> implements ITransportServer {
    /**
    ...
    protected loadPackage<T = any>(name: string, ctx: string, loader?: () => T): T | Promise<T>;
    protected loadPackageSynchronously<T = any>(name: string, ctx: string, loader?: () => T): T;
