...
class MauService {
    static async initializeDeployment(apiKey, apiSecret) {
        return (0, node_fetch_1.default)(`${cli_constants_1.API_URL}/deployments/initialize`, {
            method: 'POST',
            headers: {
    ...
    static async finalizeDeployment(apiKey, apiSecret, payload) {
        return (0, node_fetch_1.default)(`${cli_constants_1.API_URL}/deployments/finalize`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Api-Key': apiKey,
    ...
    static async verifyDeploymentStatus(apiKey, apiSecret, payload) {
        return (0, node_fetch_1.default)(`${cli_constants_1.API_URL}/deployments/${payload.deploymentId}/status?job=${payload.jobId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'X-Api-Key': apiKey,
    ...
    static async initializeSshSession(apiKey, apiSecret) {
        return (0, node_fetch_1.default)(`${cli_constants_1.API_URL}/ssh/initialize`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Api-Key': apiKey,
    ...
    static async initializeAccessLogsSession(apiKey, apiSecret) {
        return (0, node_fetch_1.default)(`${cli_constants_1.API_URL}/applications/access-logs/session/initialize`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-Api-Key': apiKey,
