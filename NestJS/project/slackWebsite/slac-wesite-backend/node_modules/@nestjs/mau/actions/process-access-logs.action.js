...
class ProcessAccessLogsAction {
    async handle(options) {
        ...
        try {
            ...
            await s3Service.pullAllAndSave(session.bucketName, timeRange, outputFile, {
            ...
            logger_1.Logger.log(`You can now visualize traffic patterns, detect anomalies, and more using the Mau platform (see ${chalk.blueBright('"Requests"')} tab).`);
            process.exit(0);
        }
        catch (err) {
